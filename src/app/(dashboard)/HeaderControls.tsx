  ...
  return (
    <div className="flex items-center w-full sm:w-auto relative">
      ...
      <div ref={searchRef} className="relative z-40 w-full sm:w-auto">
        ...
        {/* Search Input Pill */}
        <div className="relative flex items-center gap-2.5 bg-white rounded-full border border-slate-200 shadow-sm px-4 py-2.5 focus-within:ring-2 focus-within:ring-violet-500/15 focus-within:border-violet-400 transition-all w-full sm:w-72">
                      ...
                      {searchResults.navigation.map((p, i) => {
                        ...
                        return (
                          <button
                            ...
                            className="w-full text-left px-3 py-2.5 hover:bg-slate-50 hover:text-violet-700 rounded-xl flex items-center justify-between group transition-all duration-200 cursor-pointer"
                          >
                            <div className="flex items-center gap-3">
                              <div className="w-8 h-8 rounded-lg bg-slate-50 text-slate-500 flex items-center justify-center shrink-0 group-hover:bg-violet-50 group-hover:text-violet-600 transition-colors">
                                <Icon className="h-4 w-4" />
                              </div>
                              <div>
                                <span className="text-xs font-bold text-slate-800 block group-hover:text-violet-700">{p.label}</span>
                                <span className="text-[10px] text-slate-400 font-medium block mt-0.5">{p.desc}</span>
                              </div>
                            </div>
                            <span className="text-[9px] font-bold bg-slate-100 text-slate-500 rounded-full px-2 py-0.5 group-hover:bg-violet-100 group-hover:text-violet-700 transition-colors select-none">
                              Page
                            </span>
                          </button>
                        );
