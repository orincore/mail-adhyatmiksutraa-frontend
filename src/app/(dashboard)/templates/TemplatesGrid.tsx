...
const TYPE_META: Record<string, { label: string; icon: React.ComponentType<{ className?: string }>; tint: string }> = {
  builder: { label: "Visual", icon: FileCode, tint: "bg-violet-50 text-violet-600" },
                ...
                <div className="flex items-center gap-1.5 shrink-0 opacity-80 group-hover:opacity-100 transition-opacity">
                  ...
                  {canWrite && (
                    <button
                      ...
                      disabled={busy}
                      className="p-2 text-slate-400 hover:text-violet-600 hover:bg-violet-50 rounded-full transition-colors cursor-pointer disabled:opacity-50"
