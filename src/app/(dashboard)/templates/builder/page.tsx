  ...
  if (loading) {
    return (
      <div className="h-[70vh] flex flex-col items-center justify-center gap-3">
        <div className="h-10 w-10 border-4 border-slate-200 border-t-violet-600 rounded-full animate-spin" />
      ...
      <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center bg-white py-4 px-5 rounded-3xl border border-slate-200 shadow-surface gap-4">
              ...
              <div className="flex items-center gap-1 mt-1">
                <button
                  ...
                  className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-medium transition-colors cursor-pointer ${
                    templateType === "html" ? "bg-violet-50 text-violet-700" : "text-slate-400 hover:text-slate-600"
                  }`}
                >
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-medium transition-colors cursor-pointer ${
                    templateType === "text" ? "bg-violet-50 text-violet-700" : "text-slate-400 hover:text-slate-600"
                  }`}
                >
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl">
          <input
            ...
            className="w-full border border-slate-200 rounded-full px-4 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 bg-white text-slate-900 font-medium placeholder:text-slate-400 placeholder:font-normal"
          />
          <input
            type="text"
            value={subject}
                ...
                <div className="flex items-center gap-1.5 flex-wrap px-5 py-2.5 border-b border-slate-100 bg-slate-50/40 shrink-0">
                  ...
                  {variables.map((v) => (
                    <button
                      ...
                      className="px-2 py-0.5 bg-white border border-slate-200 hover:border-violet-300 hover:text-violet-700 text-slate-600 rounded-md text-[10.5px] font-medium transition-colors cursor-pointer"
                    >
                      {v.label}
                    </button>
                  ))}
