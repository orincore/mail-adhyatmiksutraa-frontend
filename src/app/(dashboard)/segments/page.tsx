            ...
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <button
                  type="button"
                  onClick={addRule}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-dashed border-slate-300 hover:border-violet-400 hover:text-violet-600 text-slate-500 font-semibold rounded-xl text-xs transition-all cursor-pointer"
                >
