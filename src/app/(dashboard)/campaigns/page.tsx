        ...
        {canWrite && (
          <div>
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4.5 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl text-sm transition-all shadow-sm shadow-violet-500/10 cursor-pointer"
            >
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <form onSubmit={handleSearchSubmit} className="flex items-center gap-2 px-6 py-4 border-b border-slate-100">
          <input
            ...
            className="flex-1 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-900"
          />
          <button
            type="submit"
                    ...
                    <tr key={camp.id} className="hover:bg-slate-50/50 transition-colors">
                      <td className="py-4 px-6 text-slate-800">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-[8px] font-bold uppercase ${
                            camp.channel === "whatsapp" ? "bg-violet-100 text-violet-800" :
                      ...
                      <td className="py-4 px-4 text-center">
                        <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase border ${
                          camp.status === "sent" ? "bg-violet-50 text-violet-600 border-violet-100" :
                      ...
                      <td className="py-4 px-6 text-right space-x-1.5">
                        ...
                        {canWrite && camp.status === "draft" && (
                          <button
                            ...
                            className="p-1.5 hover:bg-violet-50 text-slate-500 hover:text-violet-600 rounded-lg transition-all inline-flex cursor-pointer border border-violet-100"
                            title="Launch Draft"
                          >
                        ...
                        {canWrite && isWhatsappChannel && (
                          <button
                            ...
                            className="p-1.5 hover:bg-violet-55/35 text-slate-500 hover:text-violet-600 rounded-lg transition-all inline-flex cursor-pointer border border-violet-105"
                        ...
                        {canWrite && (
                          <button
                            ...
                            className="p-1.5 hover:bg-violet-55/35 text-slate-500 hover:text-violet-600 rounded-lg transition-all inline-flex cursor-pointer border border-violet-100"
                        ...
                        {canWrite && camp.status === "paused" && (
                          <button
                            ...
                            className="p-1.5 bg-slate-100 hover:bg-violet-50 text-slate-500 hover:text-violet-600 rounded-lg transition-all inline-flex cursor-pointer"
          ...
          <div className="bg-white max-w-lg w-full h-full border-l border-slate-100 shadow-2xl flex flex-col justify-between animate-slide-in">
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-900"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  {channel === "whatsapp" ? (
                    <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 text-center space-y-2">
                      <WhatsAppIcon className="h-10 w-10 text-violet-600 mx-auto" />
                      ...
                      <div className="grid grid-cols-1 gap-3 max-h-[400px] overflow-y-auto pr-1">
                        {templates.map((tpl) => (
                          ...
                          >
                            ...
                            {formTemplateId === tpl.id && <CheckCircle className="h-5 w-5 text-violet-600" />}
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {channel !== "whatsapp" && (
                    <div className="border border-slate-200/80 bg-white rounded-2xl p-4 space-y-3">
                      ...
                      >
                        ...
                        <span className={`w-9 h-5 rounded-full transition-all relative ${abEnabled ? "bg-violet-600" : "bg-slate-200"}`}>
                        ...
                        <div className="space-y-3 pt-1 animate-fade-in">
                          ...
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full border border-slate-200 rounded-xl px-3.5 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-900"
                            />
                          </div>
                          <div className="space-y-1">
                      ...
                      <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-4 animate-fade-in">
                        <div className="space-y-1">
                          ...
                          <select
                            ...
                            className="w-full border border-slate-200 bg-white rounded-xl px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 appearance-none"
                            style={{ color: "#0f172a" }}
                          >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div
                        ...
                        className={`p-4 rounded-xl border-2 transition-all cursor-pointer text-center flex flex-col items-center justify-center gap-1.5 ${
                          scheduleType === "immediate" ? "border-violet-600 bg-violet-50/20 text-violet-700" : "border-slate-200 hover:border-slate-350 text-slate-600"
                        }`}
                      >
                      ...
                      <div
                        ...
                        className={`p-4 rounded-xl border-2 transition-all cursor-pointer text-center flex flex-col items-center justify-center gap-1.5 ${
                          scheduleType === "scheduled" ? "border-violet-600 bg-violet-50/20 text-violet-700" : "border-slate-200 hover:border-slate-350 text-slate-600"
                        }`}
                      >
                      ...
                      <div className="space-y-1 animate-fade-in">
                        ...
                        <div className="flex gap-2 items-center">
                          <input
                            ...
                            className="flex-1 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white"
                            style={{ color: "#0f172a" }}
                          />
                          <button
                            type="button"
                            ...
                            className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl text-xs transition-all cursor-pointer shadow-sm shrink-0"
                          >
                            OK
                          </button>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-slate-100 hover:bg-violet-50 text-slate-600 hover:text-violet-700 font-semibold rounded-xl text-xs transition-colors border border-slate-200 hover:border-violet-250 cursor-pointer disabled:opacity-50 inline-flex items-center gap-1.5"
                          >
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50 flex justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                disabled={submitting}
                className="px-4.5 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl text-sm transition-all cursor-pointer shadow-sm disabled:opacity-50"
                >
                  ...
                  {!selectedCampaign.audience.all && !selectedCampaign.audience.segment_id && (
                    <div className="text-[10px] text-slate-505 space-y-0.5 mt-1">
                      ...
                      {selectedCampaign.audience.tags.length > 0 && (
                        <div>Tags: <span className="bg-violet-100 text-violet-800 px-1 py-0.5 rounded font-mono">{selectedCampaign.audience.tags.join(", ")}</span></div>
                      )}
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="mt-0.5">
                    <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase border ${
                      selectedCampaign.status === "sent" ? "bg-violet-50 text-violet-600 border-violet-100" :
              ...
              <form onSubmit={handleSendCampaignTest} className="space-y-4 pt-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    value={testRecipientEmail}
                    onChange={(e) => setTestRecipientEmail(e.target.value)}
                    className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white"
                    style={{ color: "#0f172a" }}
                  />
                </div>
                ...
                <div className="flex justify-end gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={sendingTest}
                    className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl text-xs transition-colors cursor-pointer disabled:opacity-50 inline-flex items-center gap-1"
                  >
                    {sendingTest ? (
                      <>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2 items-center">
                      <input
                        ...
                        className="flex-1 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-800"
                        style={{ color: "#0f172a" }}
                      />
                      <button
                        type="button"
                        ...
                        className="px-4 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl text-xs transition-all cursor-pointer shadow-sm shrink-0"
                      >
                        OK
                      </button>
                    </div>
      ...
      {testWhatsappCampaign && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center animate-fade-in text-slate-800">
          <div className="bg-white rounded-2xl max-w-md w-full border border-slate-100 shadow-2xl p-6 relative animate-scale-up">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <WhatsAppIcon className="h-5 w-5 text-violet-600" />
                <h3 className="text-lg font-bold text-slate-800">Send Test WhatsApp</h3>
              </div>
              <p className="text-slate-500 text-xs leading-relaxed">
                Test the WhatsApp delivery using your MSG91 WhatsApp integration. This will send the approved template <code className="bg-slate-100 px-1 py-0.5 rounded text-violet-600">"{testWhatsappCampaign.whatsapp_template}"</code>.
              </p>
              ...
              <form onSubmit={handleSendWhatsappTest} className="space-y-4 pt-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setTestPhone(e.target.value)}
                    placeholder="+919876543210"
                    className="w-full border border-slate-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-900"
                  />
                </div>
