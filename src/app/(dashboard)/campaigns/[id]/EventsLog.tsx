        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-2 border border-slate-200 rounded-xl text-xs w-56 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-600 bg-white text-slate-900"
            />
          </div>
          <select
            value={type}
