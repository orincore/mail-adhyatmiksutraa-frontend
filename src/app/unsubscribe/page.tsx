  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-2xl">
        <div className="bg-gradient-to-r from-violet-600 to-teal-600 p-8 text-center text-white relative">
          ...
          <p className="text-violet-100 text-sm mt-1">{BRAND_NAME}</p>
        </div>

        <div className="p-8">
          {status === "loading" && (
            <div className="flex flex-col items-center justify-center py-6">
              <div className="h-10 w-10 border-4 border-violet-500/20 border-t-violet-600 rounded-full animate-spin mb-4" />
          ...
          {status === "unsubscribed" && (
            <div className="text-center space-y-5 py-2">
              <div className="inline-flex p-3 bg-violet-50 text-violet-600 rounded-full">
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <button
                  ...
                  className="w-full inline-flex justify-center items-center px-4 py-2.5 border border-violet-600 text-violet-600 font-semibold rounded-xl text-sm hover:bg-violet-50 focus:outline-none focus:ring-2 focus:ring-violet-500/20 transition-all cursor-pointer"
                >
...
export default function UnsubscribePage() {
  return (
    <Suspense 
      fallback={
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
          <div className="h-10 w-10 border-4 border-violet-500/20 border-t-violet-600 rounded-full animate-spin" />
        </div>
      }
    >
      <UnsubscribeContent />
